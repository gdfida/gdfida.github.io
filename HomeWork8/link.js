window.onload = function(){
    ...
    //console.log(st);
    console.log("This house is not nice!".filter('nice!'));
    ...
    var teacher = new Person("Guta Dhufera");
    ...
    var teacher2 = Object.create(person('Adugna Dhufera'))
